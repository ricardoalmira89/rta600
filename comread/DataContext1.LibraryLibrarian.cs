...
namespace OptimusContext
{
    ...
    public partial class LibraryLibrarian : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<LibraryOffice> _Office;
        ...
        public LibraryLibrarian()
        {
            ...
            this._Office  = default(EntityRef<LibraryOffice>);
            OnCreated();
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LibraryOffice_LibraryLibrarian", Storage="_Office", ThisKey="OfficeId", OtherKey="Id", IsForeignKey=true)]
        public LibraryOffice Office
        {
            get
            {
            ...
            set
            {
                LibraryOffice previousValue = this._Office.Entity;
                if ((previousValue != value) || (this._Office.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging();
                    if (previousValue != null)
                    {
                        this._Office.Entity = null;
                        previousValue.Librarian.Remove(this);
                    }
                    this._Office.Entity = value;
                    if (value != null)
                    {
                        this._OfficeId = value.Id;
                        value.Librarian.Add(this);
                    }
                    else
                    {
                        this._OfficeId = default(System.Nullable<int>);
                    }
